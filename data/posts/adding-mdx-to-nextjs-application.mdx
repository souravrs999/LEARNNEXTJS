---
title: "Adding MDX to your NextJS application"
publishedAt: "2021-02-05"
summary: "A detailed walthrough for setting up and using MDX in your NextJS application."
image: "/img/blog/adding-embla-carousel-to-nextjs-application-800x514.jpg"
author: "Dark Stalker"
tags: "NextJS, Embla, Carousel"
...
to be displayed into our ** index.jsx ** file these data can be directly from our local storage or from an Api and let's add some minor styling to it.
...
- ** Carousel Viewport ** (whose inner children will be draggable and with overflow as hidden)
- ** Carousel Container ** (will be a container enclosing our slides as flex-row)
- ** Carousel Slides ** (contains all the slide components)
...
finally add an onClick event and if the user click's on a particular dot then pass the id of the dot to the ** scrollTo ** function which will scroll to the appropriate slide.
