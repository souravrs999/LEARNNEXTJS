...
Now let's import the recursiveTimeout function that we've just created in our `recursiveTimeout.js` file to our
`index.jsx` file and create an ** autoplay ** function.
...
To fix the above mentioned issue we can use ** onMouseOver ** and ** onMouseLeave ** events
