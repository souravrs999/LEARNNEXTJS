...
image_thumb: "/img/blog/adding-embla-carousel-to-nextjs-application-800x700.jpg"
image_cover: "/img/blog/adding-embla-carousel-to-nextjs-application-800x514.jpg"
author: "Dark Stalker"
...
1.  [Why Should You Care?](/blog/design#why-should-you-care)
2.  [What is a Style Guide?](/blog/design#what-is-a-style-guide)
3.  [What is a Component Library?](/blog/design#what-is-a-component-library)
4.  [What is a Design System?](/blog/design#what-is-a-design-system)
5.  [Where Should You Begin?](/blog/design#where-should-you-begin)
6.  [Building the Design System](/blog/design#building-the-design-system)
7.  [Conclusion](/blog/design#conclusion)
8.  [Resources](/blog/design#resources)
...
<a aria-label="Website Mockup" href="https://refactoringui.com/">
  <Image
    alt={`Website Mockup`}
    src={`/img/ximg_2.jpg.pagespeed.ic.tehDa3FPWy.jpg`}
    width={1467}
    height={878}
  />
</a>
...
>
  <Image
    alt={`Style Guide`}
    src={`/static/images/style-guides-component-libraries-design-systems/style-guide.png`}
    width={1468}
    height={1101}
  />
</a>
...
<a aria-label="Component Library" href="https://eva.design/">
  <Image
    ...
    src={`/static/images/style-guides-component-libraries-design-systems/components.png`}
    width={1000}
    height={376}
  />
</a>
...
>
  <Image
    alt={`Design System`}
    src={`/static/images/style-guides-component-libraries-design-systems/design-system.png`}
    width={1400}
    height={900}
  />
</a>
...
<a aria-label="Design Tokens" href="https://www.antforfigma.com/">
  <Image
    alt={`Design Tokens`}
    src={`/static/images/style-guides-component-libraries-design-systems/design-tokens.png`}
    width={1080}
    height={810}
  />
</a>
...
>
  <Image
    alt={`Icon set`}
    src={`/static/images/style-guides-component-libraries-design-systems/icons.png`}
    width={800}
    height={600}
  />
</a>
...
>
  <Image
    alt={`Monorepo`}
    src={`/static/images/style-guides-component-libraries-design-systems/monorepo.png`}
    width={1467}
    height={583}
  />
</a>
...
<Image
  ...
  src={`/static/images/style-guides-component-libraries-design-systems/button.png`}
  width={821}
  height={154}
/>
...
<a aria-label="Component Driven Development" href="https://storybook.js.org/">
  <Image
    ...
    src={`/static/images/style-guides-component-libraries-design-systems/component-driven-development.jpg`}
    width={1000}
    height={537}
  />
</a>
...
<a aria-label="Buttons" href="https://eva.design/">
  <Image
    alt={`Buttons`}
    src={`/static/images/style-guides-component-libraries-design-systems/buttons.png`}
    width={1000}
    height={641}
  />
</a>
...
<Image
  alt={`Storybook Docs`}
  src={`/static/images/style-guides-component-libraries-design-systems/storybook-docs.png`}
  width={1000}
  height={614}
/>
...
<Image
  alt={`Storybook Flow`}
  src={`/static/images/style-guides-component-libraries-design-systems/storybook-flow.png`}
  width={1300}
  height={378}
/>
...
<Image
  alt={`Atomize React`}
  src={`/static/images/style-guides-component-libraries-design-systems/atomize.png`}
  width={1300}
  height={675}
/>
