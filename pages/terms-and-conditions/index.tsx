    ...
    <Container title="Terms & Conditions - LEARNNEXT">
      <div className="flex flex-col px-5 py-12 mx-auto space-y-5 w-full max-w-4xl">
        ...
        <p className="text-base text-justify text-slate">
          ...
          conditions. Do not continue to use LEARNNEXT if you do not agree to
        ...
        <p className="text-base text-slate">
          ...
          LEARNNEXT for your own personal use subjected to restrictions set in
          these terms and conditions.
          <br />
          <br />
          You must not:
          <br />
          <br />. Republish material from LEARNNEXT
          <br />. Sell, rent or sub-license material from LEARNNEXT
          <br />. Reproduce, duplicate or copy material from LEARNNEXT
          <br />. Redistribute content from LEARNNEXT
          <br />
          <br />
          ...
          LEARNNEXT does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of LEARNNEXT,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, LEARNNEXT shall
          not be liable for the Comments or for any liability, damages or
          expenses caused and/or suffered as a result of any use of and/or
          posting of and/or appearance of the Comments on this website.
          <br />
          <br />
          LEARNNEXT reserves the right to monitor all Comments and to remove any
          ...
          <br />
          <br />
          You hereby grant LEARNNEXT a non-exclusive license to use, reproduce,
        ...
        <p className="text-base text-slate">
          ...
          the hyperlink compensates the absence of LEARNNEXT; and (d) the link
          ...
          sending an e-mail to LEARNNEXT. Please include your name, your
          ...
          <br />. By use fo the uniform resource locator being linked to; or
          <br />. By use of any other description of our Website being linked to
