...
const Hero = () => {
  return (
    <div className="flex flex-col mx-5 space-x-0 lg:flex-row lg:space-x-7">
      <div className="flex flex-col justify-center space-y-7 w-full max-w-3xl h-full">
        <p className="font-mono tracking-wide sm:text-lg text-navy-green">
          Hi, developers i am
        </p>
        <h2 className="text-4xl font-extrabold tracking-wider md:text-6xl text-slate-light">
          LEARNNEXT
        </h2>
        <h3 className="text-3xl font-extrabold md:text-4xl text-slate">
          A collection of all things Next.
        </h3>
        <p className="max-w-xl text-sm tracking-wide lg:text-base text-slate">
          Blog&apos;s and Article&apos;s for NextJS a React Framework for
          Production from the{' '}
          <a
            href="https://www.vercel.com"
            className="font-bold text-navy-green"
          >
            Vercel
          </a>{' '}
          team, learn, improve and develop your skill as a NextJS developer
        </p>
        <a
          href="#recent_posts"
          aria-label="Go to recently published Articles seciton."
          className="grid place-items-center font-medium py-4 max-w-[250px] text-sm rounded border-2 border-navy-green text-navy-green font-mono hover:bg-navy-green hover:text-navy-light"
        >
          Check out my Articles!
        </a>
        <div className="flex space-x-5 text-slate-light">
          {socialLinks.map((sm) => (
            <a
              href={sm.link}
              rel="noreferrer"
              ...
              key={sm.social}
              aria-label={`Visit LEARNNEXT'S ${sm.social} page.`}
            >
              {sm.icon}
            </a>
          ))}
      ...
      <div className="flex justify-center items-center w-full">
        <svg
          className="w-full text-slate next-logo-animate"
